        ...
        <div class="modal-dialog modal-dialog-centered modal-simple">
            ...
            <div class="modal-body">
                ...
                <div class="text-center mb-6">
                    <h3 class="modal-title" id="modalTitle">Add Complaints</h3>
                    <p class="text-body-secondary">Complaints you may use and assign to your users.</p>
                </div>
                
                <form id="complaintForm" class="row">
                    <input type="hidden" id="complaintId">
                    <div class="col-12 form-control-validation mb-4">
                       <label class="form-label" for="complaint-user">User</label>
                        <select id="complaint-user" class="form-select" name="complaint_user" required>
                        </select>
                        <div class="invalid-feedback" id="complaint_userError"></div>
                    </div>
                    <div class="col-12 form-control-validation mb-4">
...
<script>
    ...
    function editComplaint(id) {
        isEdit = true;
        $.get(`/complanits/${id}/edit`, function (data) {
