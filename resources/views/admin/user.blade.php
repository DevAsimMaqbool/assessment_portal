                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start justify-content-between">
                            <div class="content-left">
                                ...
                                <div class="d-flex align-items-center my-1">
                                    <h4 class="text-success mb-0 me-2">{{ $answeredSelf }}</h4>
                                    <!-- <p class="text-success mb-0">(+18%)</p> -->
                                </div>
                                <small class="mb-0">Self Assessment done </small>
                            </div>
                            <div class="avatar">
                                <span class="avatar-initial rounded bg-label-danger">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start justify-content-between">
                            <div class="content-left">
                                ...
                                <div class="d-flex align-items-center my-1">
                                    <h4 class="text-success mb-0 me-2">{{ $answeredStakeholders }}</h4>
                                    <!-- <p class="text-danger mb-0">(-14%)</p> -->
                                </div>
                                <small class="mb-0">Stakeholders Assessment done</small>
                            </div>
                            <div class="avatar">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start justify-content-between">
                            <div class="content-left">
                                ...
                                <div class="d-flex align-items-center my-1">
                                    <h4 class="text-success mb-0 me-2">{{ $pendding }}</h4>
                                    <!-- <p class="text-success mb-0">(+42%)</p> -->
                                </div>
                                <small class="mb-0">Pending Assessment</small>
                            </div>
                            <div class="avatar">
                ...
                success: function (data) {
                    ...
                    if ($.fn.DataTable.isDataTable('#userTable')) {
                                    ...
                                    render: function (data) {
                                        return `
                                                                                                    <div class="d-flex align-items-center">
                                                                                                        ...
                                                                                                        <a class="btn btn-icon btn-text-secondary rounded-pill waves-effect" href="/user_report/${data.id}" target="_blank">
                        ...
                        setTimeout(() => {
                            ...
                            const $departmentCol = $(`
                                                                                                    <div class="col-md-auto mt-2 mt-md-0 align-self-center">
