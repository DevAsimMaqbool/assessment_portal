...
@section('content')
  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    ...
    class="fw-medium">{{ Auth::user()->level }}</span></li>
    </ul>
    </div>
    ...
    class="fw-medium mx-2">Status:</span> <span>{{ Auth::user()->status }}</span></li>
    <li class="d-flex align-items-center mb-4"><i class="icon-base ti tabler-crown icon-lg"></i><span
    class="fw-medium mx-2">Role:</span> <span>{{ Auth::user()->level }}</span></li>
    </ul>
