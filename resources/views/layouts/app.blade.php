<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" data-assets-path="{{ asset('admin/assets') }}/" data-template="vertical-menu-template" class="layout-navbar-fixed layout-menu-fixed layout-compact one" data-skin="default" data-bs-theme="light" dir="ltr">
    <head>
        <meta charset="utf-8">
