...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('admin/assets/vendor/css/pages/front-page-help-center.css')); ?>" />
  ...
  <script src="<?php echo e(asset('admin/assets/js/front-config.js')); ?>"></script>

</head>

<body>
  <script src="<?php echo e(asset('admin/assets/vendor/js/dropdown-hover.js')); ?>"></script>
  <script src="<?php echo e(asset('admin/assets/vendor/js/mega-dropdown.js')); ?>"></script><!-- Navbar: Start -->
  <nav class="layout-navbar shadow-none py-0">
      ...
      <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-8">
        ...
        <div class="navbar-brand app-brand demo d-flex py-0 me-4 me-xl-8 ms-0">
          ...
          <a href="/" class="app-brand-link">
            <img style="width: 140px;" src="<?php echo e(asset('admin/assets/img/avatars/superior.svg')); ?>">
          </a>
        </div>
    ...
    <a href="<?php echo e(route('login')); ?>" class="btn btn-primary">
      ...
      class="d-none d-md-block">Login</span>
    </a>
    </li class="nav-item dropdown-style-switcher dropdown me-2 me-xl-1">
  ...
  <!-- <section class="section-py first-section-pt help-center-header position-relative overflow-hidden">
    <img class="banner-bg-img z-n1" src="<?php echo e(asset('admin/assets/img/pages/header.png')); ?>" alt="Help center header" />
  ...
  <section class="section-py">
    <div class="container">
      <h4 class="text-center mb-6">Assessment Portal Dashboard for Employees</h4>
      <div class="row">
  ...
  <footer class="landing-footer bg-body footer-text">
    <div class="footer-top position-relative overflow-hidden z-1">
      <img src="<?php echo e(asset('admin/assets/img/pages/footer-bg.png')); ?>" alt="footer bg"
...
</html><?php /**PATH /home/ipza8kynww9c/public_html/assessment.digitaldiraction.com/resources/views/welcome.blade.php ENDPATH**/ ?>