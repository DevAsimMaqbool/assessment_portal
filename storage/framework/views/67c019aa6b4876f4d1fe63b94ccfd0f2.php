            ...
            <div class="col-12">
                <div class="col-12 d-flex justify-content-between">
                    <!-- <a href="<?php echo e(route('questions')); ?>"><button type="button" class="btn btn-primary btn-next">
                        ...
                        <a href="<?php echo e(route('question.stakeholder')); ?>"><button type="button" class="btn btn-primary btn-next">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ipza8kynww9c/public_html/assessment.digitaldiraction.com/resources/views/admin/question.blade.php ENDPATH**/ ?>