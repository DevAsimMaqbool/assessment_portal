  ...
  <ul class="navbar-nav flex-row align-items-center ms-md-auto">
      ...
      <li class="nav-item navbar-dropdown dropdown-user dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end">
          <li>
            <a class="dropdown-item mt-0" href="<?php echo e(route('profile.edit')); ?>">
              <div class="d-flex align-items-center">
                ...
                <div class="flex-grow-1">
                  ...
                  <small class="text-body-secondary"><?php echo e(Auth::user()->level); ?></small>
                </div>
              </div>
            </a>
          </li>
          ...
          <li>
            <a class="dropdown-item" href="<?php echo e(route('profile.edit')); ?>"> <i class="icon-base ti tabler-user me-3 icon-md"></i><span class="align-middle">My Profile</span> </a>
          </li>
...
<!-- / Navbar --><?php /**PATH /Applications/MAMP/htdocs/AssessmentPortal/resources/views/layouts/navbar.blade.php ENDPATH**/ ?>