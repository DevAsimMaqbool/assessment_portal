          ...
          <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <ul class="list-unstyled d-flex align-items-center avatar-group mb-0">
              <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="Vinnie Mostowy" class="avatar pull-up">
                <img class="rounded-circle" src="<?php echo e(asset('admin/assets/img/avatars/5.png')); ?>" alt="Avatar" />
              </li>
              <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="Allen Rieske" class="avatar pull-up">
                <img class="rounded-circle" src="<?php echo e(asset('admin/assets/img/avatars/12.png')); ?>" alt="Avatar" />
              </li>
              <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="Julee Rossignol" class="avatar pull-up">
                <img class="rounded-circle" src="<?php echo e(asset('admin/assets/img/avatars/6.png')); ?>" alt="Avatar" />
              </li>
              <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="Kaith D'souza" class="avatar pull-up">
                <img class="rounded-circle" src="<?php echo e(asset('admin/assets/img/avatars/3.png')); ?>" alt="Avatar" />
              </li>
            </ul>
          </div>
          ...
          <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <ul class="list-unstyled d-flex align-items-center avatar-group mb-0">
              <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="Jimmy Ressula" class="avatar pull-up">
                <img class="rounded-circle" src="<?php echo e(asset('admin/assets/img/avatars/4.png')); ?>" alt="Avatar" />
              </li>
              <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="John Doe" class="avatar pull-up">
                <img class="rounded-circle" src="<?php echo e(asset('admin/assets/img/avatars/1.png')); ?>" alt="Avatar" />
              </li>
              <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="Kristi Lawker" class="avatar pull-up">
                <img class="rounded-circle" src="<?php echo e(asset('admin/assets/img/avatars/2.png')); ?>" alt="Avatar" />
              </li>
              <li class="avatar">
          ...
          <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <ul class="list-unstyled d-flex align-items-center avatar-group mb-0">
              ...
              <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="Rishi Swaat" class="avatar pull-up">
                <img class="rounded-circle" src="<?php echo e(asset('admin/assets/img/avatars/9.png')); ?>" alt="Avatar" />
              </li>
          ...
          <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <ul class="list-unstyled d-flex align-items-center avatar-group mb-0">
              <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="Kim Merchent" class="avatar pull-up">
                <img class="rounded-circle" src="<?php echo e(asset('admin/assets/img/avatars/10.png')); ?>" alt="Avatar" />
              </li>
              <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top" title="Sam D'souza" class="avatar pull-up">
                <img class="rounded-circle" src="<?php echo e(asset('admin/assets/img/avatars/13.png')); ?>" alt="Avatar" />
              </li>
        ...
        <div class="row h-100">
          <div class="col-sm-5">
            <div class="d-flex align-items-end h-100 justify-content-center mt-sm-0 mt-4">
              <img src="<?php echo e(asset('admin/assets/img/illustrations/add-new-roles.png')); ?>" class="img-fluid" alt="Image" width="83" />
            </div>
          </div>
          <div class="col-sm-7">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/AssessmentPortal/resources/views/admin/role/index.blade.php ENDPATH**/ ?>