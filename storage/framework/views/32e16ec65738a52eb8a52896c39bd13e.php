...
<script>
    ...
    function fetchPermissions() {
        $.ajax({
            url: "<?php echo e(route('permission.index')); ?>",
            method: "GET",
            dataType: "json",
    ...
    $('#permissionForm').submit(function (e) {
        ...
        const url = isEdit ? `/permission/${id}` : "<?php echo e(route('permission.store')); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/AssessmentPortal/resources/views/admin/permissions/index.blade.php ENDPATH**/ ?>