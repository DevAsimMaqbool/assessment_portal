...
<aside id="layout-menu" class="layout-menu menu-vertical menu">
  ...
  <div class="app-brand demo">
    <a href="/dashboard" class="app-brand-link">
      <img style="width: 50px;" src="<?php echo e(asset('admin/assets/img/avatars/tsg1.png')); ?>">
    </a>
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item">
      <a href="<?php echo e(route('selfFeedback')); ?>" class="menu-link">
...
<!-- / Menu --><?php /**PATH /Applications/MAMP/htdocs/AssessmentPortal/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>